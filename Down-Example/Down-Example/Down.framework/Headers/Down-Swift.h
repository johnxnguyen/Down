...
/// returns:
/// An instance of Self
- (nullable instancetype)initWithFrame:(CGRect)frame markdownString:(NSString * _Nonnull)markdownString openLinksInBrowser:(BOOL)openLinksInBrowser templateBundle:(NSBundle * _Nullable)templateBundle error:(NSError * _Nullable * _Nullable)error didLoadSuccessfully:(void (^ _Nullable)(void))didLoadSuccessfully OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_OBJC("Swift initializer 'DownView.init(frame:markdownString:openLinksInBrowser:templateBundle:didLoadSuccessfully:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
- (BOOL)updateWithMarkdownString:(NSString * _Nonnull)markdownString error:(NSError * _Nullable * _Nullable)error didLoadSuccessfully:(void (^ _Nullable)(void))didLoadSuccessfully SWIFT_DEPRECATED_OBJC("Swift method 'DownView.update(markdownString:didLoadSuccessfully:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
